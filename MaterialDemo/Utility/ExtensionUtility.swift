...
public extension UIView {
    var width_view:      CGFloat { return self.frame.size.width }
    var height_view:     CGFloat { return self.frame.size.height }
    
    var origin:     CGPoint { return self.frame.origin }
    var x_view:          CGFloat { return self.frame.origin.x }
    var y_view:          CGFloat { return self.frame.origin.y }
